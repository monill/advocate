...
class PaymentMethodsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.financial.payment_methods.index', compact('methods'));
    }

    public function create()
    {
        return view('dashboard.financial.payment_methods.create');
    }
    ...
    public function edit($method_id)
    {
        ...
        return view('dashboard.financial.payment_methods.edit', compact('method'));
    }
