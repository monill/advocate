...
@section('subtitle', 'Adicionar Gênero')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-text">Para inserir um novo gênero, basta preencher os dados abaixo.</p>
            </div>
            <div class="card-body">
                @includeIf('errors.errors', [$errors])
                @include('errors.messages')
                <form class="form form-vertical" action="{{ route('genders.store') }}" method="post">
                    @csrf
                    <div class="mb-3">
