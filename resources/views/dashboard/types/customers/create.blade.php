...
@section('subtitle', 'Adicionar Clientes')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Adicionar Clientes</h4>
                <p class="card-text">Para inserir um novo tipo de clientes, basta preencher os dados abaixo.</p>
            </div>
            <div class="card-body">
