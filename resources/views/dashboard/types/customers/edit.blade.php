...
@section('subtitle', 'Editar Clientes')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-text">Para alterar tipo de clientes, basta preencher os dados abaixo.</p>
            </div>
            <div class="card-body">
                @includeIf('errors.errors', [$errors])
                @include('errors.messages')
                <form class="form form-vertical" action="{{ route('clients.update', $type->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
