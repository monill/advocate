...
@section('subtitle', 'Adicionar Categoria Financeira')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Adicionar Categoria Financeira</h4>
                <p class="card-text">Para inserir uma nova categoria financeira, basta preencher os dados abaixo.</p>
            </div>
            <div class="card-body">
